...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "c-sdk-client-id-01" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 	       "modbus_gateway" ///< Thing Name of the Shadow this device is associated with
